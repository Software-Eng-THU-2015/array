...
body2 = '{"button": [{"name": "健康数据","sub_button": [{"type": "view","name": "步数统计","url": "http://www.soso.com/"},{"type": "view","name": "心率血压","url": "http://v.qq.com/"},{"type": "view","name": "睡眠记录","url": "http://www.baidu.com/"}]}]}'

#用户关注事件
def subEvent(msg):
    tools.menuCreate(body)
    print "hehe"
